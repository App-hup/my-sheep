  ...
  const handleImportFile = useCallback((file: File) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (!data.pregnancies || !data.diseases || !data.births || !data.feedSections || !data.vaccinations || !data.sheepProfiles || !data.financialRecords || !data.weightRecords) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background gradient-mesh-enhanced noise-overlay">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 py-6 pb-24 lg:pb-6">
        ...
        {/* ── Second Dashboard Row (Vaccinations, Profiles, Financial, Weight) ── */}
        <div className="hidden md:grid grid-cols-4 gap-3 mb-6 stagger-blur">
          <DashboardCard
